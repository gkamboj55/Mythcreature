...
export function BookPageLeft({ title, image, imageAlt, firstParagraph }: BookPageLeftProps) {
  return (
    <div className="flex flex-col">
      <h2 className="text-center text-xl md:text-2xl font-bold text-amber-800 mb-4 font-serif">{title}</h2>

      <div className="flex justify-center mb-4">
        <div className="relative w-full max-w-[200px] aspect-square rounded-lg overflow-hidden border-2 border-amber-200 shadow-md">
